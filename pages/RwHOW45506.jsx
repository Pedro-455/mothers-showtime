...
export default function RwHOW45506() {
  ...
  async function handleSendEmail() {
    ...
    try {
      ...
      const res = await fetch(`${SUPABASE_URL}/functions/v1/send-sellsheet-email`, {
        ...
        body: JSON.stringify({ name, email, optIn, carName: "3A Bucklands Beach Road, Bucklands Beach", carUrl: "https://linqr.global/rw-HOW45506" }),
      });
  ...
  async function handleQuickSend() {
    ...
    try {
      const res = await fetch(`${SUPABASE_URL}/functions/v1/send-sellsheet-email`, {
        method: "POST",
        headers: { "Content-Type": "application/json", "Authorization": `Bearer ${SUPABASE_ANON_KEY}` },
        body: JSON.stringify({ name, email, optIn: false, carName: "3A Bucklands Beach Road, Bucklands Beach", carUrl: "https://linqr.global/rw-HOW45506" }),
      });
      if (!res.ok) throw new Error("Failed to send");
      setSent(true);
    } catch (e) {
  ...
  const specs = [{"label":"Bedrooms","value":"5"},{"label":"Bathrooms","value":"4"},{"label":"Land","value":"419m²"},{"label":"Parking","value":"2 Garage"},{"label":"Built","value":"1 Year Old"},{"label":"School Zone","value":"Macleans College"},{"label":"Views","value":"Panoramic Sea Views"},{"label":"Sale","value":"Auction 9 June"}];
      ...
      <div style={styles.page}>
        ...
        <div style={styles.rwHeader}>
          <div style={styles.rwLogoBox}>
            ...
            <span style={styles.rwBranch}>Ray White Howick</span>
          </div>
          <div style={styles.rwTagline}>Five AM Realty Limited Licensed (REAA 2008)</div>
        </div>

        <div style={styles.hero}>
          <img src="/HOW45506.JPG" alt="3A Bucklands Beach Road, Bucklands Beach" style={styles.heroImg} />
          <div style={styles.heroOverlay} />
          <div style={styles.heroBadge}><span style={styles.heroBadgeText}>AUCTION 9 JUNE · BUCKLANDS BEACH</span></div>
          <div style={styles.heroContent}>
            <p style={styles.heroEyebrow}>3A BUCKLANDS BEACH ROAD</p>
            <h1 style={styles.heroTitle}>Bucklands Beach</h1>
            <p style={styles.heroSub}>Luxury Coastal Living · Panoramic Sea Views</p>
          </div>
        </div>

        <div style={styles.statsBar}>
          <div key="Bedrooms" style={styles.statItem}>
            <p style={styles.statValue}>5</p>
            <p style={styles.statLabel}>Bedrooms</p>
          </div>
          <div key="Bathrooms" style={styles.statItem}>
            <p style={styles.statValue}>4</p>
            <p style={styles.statLabel}>Bathrooms</p>
          </div>
          <div key="Land Area" style={styles.statItem}>
            <p style={styles.statValue}>419m²</p>
            <p style={styles.statLabel}>Land Area</p>
          </div>
          <div key="Auction" style={styles.statItem}>
            <p style={styles.statValue}>9 Jun</p>
            <p style={styles.statLabel}>Auction</p>
          </div>
        </div>
        ...
        <div style={styles.content}>
          ...
          <div style={styles.section}>
            <h2 style={styles.sectionTitle}>Near-New Coastal Masterpiece</h2>
            <p style={styles.bodyText}>Wake up to peaceful panoramic sea views and experience a lifestyle where every day feels like a holiday. Positioned in the prestigious Macleans zone of Bucklands Beach, this near-new coastal residence — built just one year ago — delivers the perfect balance of grand family living, refined elegance and relaxed waterfront charm. Designed to maximise its stunning panoramic sea views, this impressive three-level home combines timeless style with modern comfort. High-quality finishes, underfloor heating, heat pumps and double internal access garaging provide everyday comfort, while the glass-framed balcony delivers sweeping sea views and unforgettable sunsets as part of daily life.</p>
            <a href="https://rwbotany.co.nz/properties/residential-for-sale/manukau-city/bucklands-beach-2012/house/3512410" target="_blank" rel="noopener noreferrer" style={styles.learnMore}>
          ...
          <div style={styles.section}>
            ...
            <div style={styles.featureGrid} className="feature-grid">
              {["Near-New — Built 1 Year Ago","Panoramic Sea Views","3-Level Architectural Home","Underfloor Heating Throughout","Designer Kitchen — Premium Appliances","Glass-Framed Balcony","Master Retreat with Walk-in Wardrobe","Separate Lounge / Media Room","Macleans College Zone","Half Moon Bay Marina — Moments Away","Double Internal Access Garage","3.2m Stud Ceiling — Main Living"].map((f) => (
          ...
          <div style={styles.actionSection}>
            <a href="https://rwbotany.co.nz/properties/residential-for-sale/manukau-city/bucklands-beach-2012/house/3512410" target="_blank" rel="noopener noreferrer" style={styles.primaryBtn} className="primary-btn">
              View Full Listing & All Photos →
            </a>
            <a href="https://rwbotany.co.nz/properties/residential-for-sale/manukau-city/bucklands-beach-2012/house/3512410" target="_blank" rel="noopener noreferrer" style={styles.secondaryBtn} className="secondary-btn">
          ...
          <div style={styles.saveSection}>
            ...
            {sent && (
              <div style={styles.successBox}>
                ...
                <p style={styles.successText}>Check your inbox — the details are headed to {email}</p>
              </div>
            )}
          </div>
          ...
          <div style={styles.agentBox}>
            ...
            <div style={styles.agentInfo}>
              <p style={styles.agentBranch}>Ray White Howick</p>
