...
export default function PortalDashboard({ dealer, onLogout, onAddNew, onEdit }) {
    ...
    <div style={styles.outer}>
      <div style={styles.page}>
        ...
        <div style={styles.statsBar}>
          ...
          <div style={styles.statItem}>
            <p style={styles.statValue}>{listings.filter(l => l.published).length}</p>
          ...
          <div style={styles.statItem}>
            <p style={styles.statValue}>{dealer.code}</p>
        ...
        <div style={styles.content}>
          <div style={styles.contentHeader}>
            ...
            <button style={styles.addBtn} onClick={onAddNew}>+ Add New Vehicle</button>
          </div>
          ...
          {!loading && listings.length === 0 && (
            <div style={styles.emptyState}>
              ...
              <p style={styles.emptySub}>Add your first vehicle to get started</p>
              <button style={styles.addBtn} onClick={onAddNew}>+ Add New Vehicle</button>
            </div>
          )}
          ...
          {listings.map(listing => (
            <div key={listing.id} style={styles.listingCard}>
              ...
              <div style={styles.listingInfo}>
                <p style={styles.listingTitle}>{listing.year} {listing.make} {listing.model}</p>
                <p style={styles.listingMeta}>{listing.colour} · {listing.engine} · Stock #{listing.stock_number}</p>
                ...
                <div style={styles.listingUrl}>
                  ...
                  <a href={`https://linqr.global/${listing.slug}`} target="_blank" rel="noopener noreferrer" style={styles.viewLink}>View →</a>
                </div>
              </div>
...
const styles = {
  ...
  header: { background: "#1B6157", padding: "16px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" },
  logo: { height: 36, width: "auto" },
  headerRight: { display: "flex", alignItems: "center", gap: 16 },
  dealerName: { color: "#fff", fontSize: 14, fontWeight: 700, margin: 0 },
  logoutBtn: { background: "rgba(255,255,255,0.2)", color: "#fff", border: "none", borderRadius: 6, padding: "8px 16px", fontSize: 13, cursor: "pointer", fontFamily: "Georgia, serif" },
  statsBar: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", background: "#fff", borderBottom: "1px solid #eee", padding: "20px 24px" },
  statItem: { textAlign: "center" },
  statValue: { fontSize: 28, fontWeight: 900, color: "#1B6157", margin: "0 0 4px", fontFamily: "Georgia, serif" },
  ...
  addBtn: { background: "#1B6157", color: "#fff", border: "none", borderRadius: 8, padding: "12px 20px", fontSize: 14, fontWeight: 700, cursor: "pointer", fontFamily: "Georgia, serif" },
  ...
  listingPrice: { fontSize: 15, fontWeight: 700, color: "#1B6157", margin: "0 0 6px" },
  ...
  viewLink: { fontSize: 12, color: "#1B6157", fontWeight: 700, textDecoration: "none" },
