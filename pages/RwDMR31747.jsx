...
export default function RwDMR31747() {
  ...
  async function handleSendEmail() {
    ...
    try {
      ...
      const res = await fetch(`${SUPABASE_URL}/functions/v1/send-sellsheet-email`, {
        ...
        body: JSON.stringify({ name, email, optIn, carName: "66A Marine Parade, Mellons Bay", carUrl: "https://linqr.global/rw-DMR31747" }),
      });
  ...
  async function handleQuickSend() {
    ...
    try {
      const res = await fetch(`${SUPABASE_URL}/functions/v1/send-sellsheet-email`, {
        method: "POST",
        headers: { "Content-Type": "application/json", "Authorization": `Bearer ${SUPABASE_ANON_KEY}` },
        body: JSON.stringify({ name, email, optIn: false, carName: "66A Marine Parade, Mellons Bay", carUrl: "https://linqr.global/rw-DMR31747" }),
      });
      if (!res.ok) throw new Error("Failed to send");
      setSent(true);
    } catch (e) {
  ...
  const specs = [{"label":"Bedrooms","value":"6"},{"label":"Bathrooms","value":"5"},{"label":"Land","value":"833m² / 0.21 acres"},{"label":"Interior","value":"~420m²"},{"label":"Parking","value":"6 Cars"},{"label":"School Zone","value":"Macleans College"},{"label":"Views","value":"Hauraki Gulf Panorama"},{"label":"Price","value":"By Negotiation"}];
      ...
      <div style={styles.page}>
        ...
        <div style={styles.rwHeader}>
          <div style={styles.rwLogoBox}>
            ...
            <span style={styles.rwBranch}>Ray White Flat Bush</span>
          </div>
          <div style={styles.rwTagline}>Five AM Realty Limited Licensed (REAA 2008)</div>
        </div>

        <div style={styles.hero}>
          <img src="/DMR31747.JPG" alt="66A Marine Parade, Mellons Bay" style={styles.heroImg} />
          <div style={styles.heroOverlay} />
          <div style={styles.heroBadge}><span style={styles.heroBadgeText}>HOUSE FOR SALE · MELLONS BAY</span></div>
          <div style={styles.heroContent}>
            <p style={styles.heroEyebrow}>66A MARINE PARADE</p>
            <h1 style={styles.heroTitle}>Mellons Bay</h1>
            <p style={styles.heroSub}>Unrivalled Coastal Luxury · Hauraki Gulf Views</p>
          </div>
        </div>
        ...
        <div style={styles.statsBar}>
          ...
          <div key="Land Area" style={styles.statItem}>
            <p style={styles.statValue}>833m²</p>
            <p style={styles.statLabel}>Land Area</p>
          </div>
          <div key="Price" style={styles.statItem}>
            <p style={styles.statValue}>POA</p>
        ...
        <div style={styles.content}>
          ...
          <div style={styles.section}>
            <h2 style={styles.sectionTitle}>Unrivalled Coastal Luxury on Marine Parade</h2>
            <p style={styles.bodyText}>Experience the ultimate in seaside living with this spectacular frontline waterfront residence — positioned on the most prestigious street in East Auckland. With uninterrupted panoramic sea views stretching across the Hauraki Gulf, this home redefines coastal elegance. Boasting approximately 420m² of refined interior space on an 833m² freehold site, this architectural masterpiece offers six luxurious bedrooms, multiple living zones, and expansive entertaining areas designed to capture the ever-changing ocean views. The current owners have moved on — now it's your opportunity.</p>
            <a href="https://rwbotany.co.nz/properties/residential-for-sale/manukau-city/mellons-bay-2014/house/3400473" target="_blank" rel="noopener noreferrer" style={styles.learnMore}>
          ...
          <div style={styles.section}>
            ...
            <div style={styles.featureGrid} className="feature-grid">
              {["Frontline Waterfront Residence","Panoramic Hauraki Gulf Views","Most Prestigious Street in East Auckland","~420m² of Interior Space","Six Luxurious Bedrooms","Multiple Living Zones","Expansive Entertaining Areas","Architectural Masterpiece","833m² Freehold Site","Macleans College Zone","Double Garage + 4 Off Street Parks","Movie Room"].map((f) => (
          ...
          <div style={styles.actionSection}>
            <a href="https://rwbotany.co.nz/properties/residential-for-sale/manukau-city/mellons-bay-2014/house/3400473" target="_blank" rel="noopener noreferrer" style={styles.primaryBtn} className="primary-btn">
              View Full Listing & All Photos →
            </a>
            <a href="https://rwbotany.co.nz/properties/residential-for-sale/manukau-city/mellons-bay-2014/house/3400473" target="_blank" rel="noopener noreferrer" style={styles.secondaryBtn} className="secondary-btn">
          ...
          <div style={styles.agentBox}>
            ...
            <div style={styles.agentInfo}>
              <p style={styles.agentBranch}>Ray White Flat Bush</p>
