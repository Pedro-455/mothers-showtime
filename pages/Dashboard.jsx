      ...
      <div style={styles.page}>
        ...
        <div style={styles.detailGrid}>
          ...
          {selectedEntry.judging_number && (
            <div style={styles.detailCard}>
              <p style={styles.detailLabel}>JUDGING NUMBER</p>
    ...
    <div style={styles.page}>
      ...
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.headerSub}>Auckland Showgrounds · June 2026</p>
        </div>
      ...
      <div style={styles.footer}>
        <p style={styles.footerText}>Mothers Showtime Dashboard · Chrome 26 · June 2026</p>
      </div>
    </div>
  );
}
