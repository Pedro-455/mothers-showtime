...
export default function RwHOW45015() {
  ...
  async function handleSendEmail() {
    ...
    try {
      ...
      const res = await fetch(`${SUPABASE_URL}/functions/v1/send-sellsheet-email`, {
        ...
        body: JSON.stringify({ name, email, optIn, carName: "7a Musick Point Road, Buckland Beach", carUrl: "https://linqr.global/rw-HOW45015" }),
      });
  ...
  async function handleQuickSend() {
    ...
    try {
      const res = await fetch(`${SUPABASE_URL}/functions/v1/send-sellsheet-email`, {
        method: "POST",
        headers: { "Content-Type": "application/json", "Authorization": `Bearer ${SUPABASE_ANON_KEY}` },
        body: JSON.stringify({ name, email, optIn: false, carName: "7a Musick Point Road, Buckland Beach", carUrl: "https://linqr.global/rw-HOW45015" }),
      });
      if (!res.ok) throw new Error("Failed to send");
      setSent(true);
    } catch (e) {
  ...
  const specs = [{"label":"Bedrooms","value":"5"},{"label":"Bathrooms","value":"2"},{"label":"Land","value":"1,009m² / 0.25 acres"},{"label":"School Zone","value":"Macleans College"},{"label":"Property Type","value":"House for Sale"},{"label":"Location","value":"Buckland Beach"},{"label":"Beach","value":"30 second walk"},{"label":"Price","value":"By Negotiation"}];
    ...
    <div style={styles.pageOuter}>
      <div style={styles.page}>
        ...
        <div style={styles.hero}>
          <img src="/HOW45015.JPG" alt="7a Musick Point Road, Buckland Beach" style={styles.heroImg} />
          <div style={styles.heroOverlay} />
          <div style={styles.heroBadge}><span style={styles.heroBadgeText}>HOUSE FOR SALE · BUCKLAND BEACH</span></div>
          <div style={styles.heroContent}>
            <p style={styles.heroEyebrow}>7A MUSICK POINT ROAD</p>
            <h1 style={styles.heroTitle}>Buckland Beach</h1>
            <p style={styles.heroSub}>Walk to the Beach · Develop, Renovate or Enjoy</p>
          </div>
        </div>
        ...
        <div style={styles.statsBar}>
          ...
          <div key="Land Area" style={styles.statItem}>
            <p style={styles.statValue}>1,009m²</p>
        ...
        <div style={styles.content}>
          ...
          <div style={styles.section}>
            <h2 style={styles.sectionTitle}>First Time on Market Since 1984</h2>
            <p style={styles.bodyText}>A rare opportunity presents itself for the very first time on the market since 1984. Whether it's the circa 1,009m² block, the Macleans College and Buckland Beach Intermediate school zoning, the 30 second walk to the beach, or the option to develop with services onsite (STCA) — the world is your oyster at 7a Musick Point Road. The current home is a whopping 5 bedroom, 2 bathroom double storey house with ocean vistas of Buckland Beach. The options are endless, only limited by your imagination.</p>
            <a href="https://rwbotany.co.nz/properties/residential-for-sale/manukau-city/bucklands-beach-2012/house/3485069" target="_blank" rel="noopener noreferrer" style={styles.learnMore}>
          ...
          <div style={styles.section}>
            ...
            <div style={styles.featureGrid} className="feature-grid">
              {["First on Market Since 1984","30 Second Walk to Beach","Ocean Vistas — Sky Tower Views","Development Potential (STCA)","Services Onsite","Macleans College Zone","Double Storey Home","Wrap-Around Deck","Rumpus & Family Room","Large Central Living Room","1,009m² Section","Landscaped Gardens & Petanque Pitch"].map((f) => (
          ...
          <div style={styles.actionSection}>
            <a href="https://rwbotany.co.nz/properties/residential-for-sale/manukau-city/bucklands-beach-2012/house/3485069" target="_blank" rel="noopener noreferrer" style={styles.primaryBtn} className="primary-btn">
              View Full Listing & All Photos →
            </a>
            <a href="https://rwbotany.co.nz/properties/residential-for-sale/manukau-city/bucklands-beach-2012/house/3485069" target="_blank" rel="noopener noreferrer" style={styles.secondaryBtn} className="secondary-btn">
